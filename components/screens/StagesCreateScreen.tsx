...
const MOCK_PREVIEW_FIELDS = [
  { label: 'Full Name', type: 'text', required: true },
  { label: 'Date of Birth', type: 'date', required: true },
  { label: 'Height (cm)', type: 'number', required: false },
  { label: 'Education Level', type: 'select', required: true },
];
    ...
    <div className="mx-10 space-y-6">
      ...
      <div className="space-y-1 flex flex-row justify-between items-center">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold text-foreground">Create New Stage</h1>
        ...
        <div className="rounded-2xl border border-border bg-card p-5 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input placeholder="e.g. Pre-Assessment" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea placeholder="Describe what happens in this stage..." rows={3} />
            </div>
